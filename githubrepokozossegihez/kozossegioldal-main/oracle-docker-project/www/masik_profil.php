...
<body>
  <div class="navbar">
    ...
    <div class="navbar-links">
      ...
      <a href="profil.php" class="<?php echo basename($_SERVER['PHP_SELF']) == 'profil.php' ? 'active' : ''; ?>">Saját
        profil</a>
  ...
  <div id="box">
    ...
    <div id="adatok">
      ...
      <p id="job"><?php echo !empty($felhasznalo['MUNKAHELY']) ? $felhasznalo['MUNKAHELY'] : 'Nincs megadva'; ?></p>
    </div>
  </div>
  ...
  <div class="button">
    ...
    <?php else: ?>
      <button class="link" disabled>Üzenet küldés letiltva</button>
    <?php endif; ?>
  </div>
